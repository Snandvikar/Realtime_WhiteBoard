...
return(
    <div className="row">
      ...
      >Users</button>
       {
         !openedUserTab && (
            <div
            className="position-flex top-0 left-0 h-100 text-white bg-dark"
      ...
      <h1 className="text-center  py-4">
        ...
        {
         user?.presenter && (
            <div className="col-md-10 mx-auto px-5 mt-4 mb-5 d-flex align-items-center justify-content-between">
